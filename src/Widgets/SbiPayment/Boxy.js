    ...
    <Grid container className={classes.root} spacing={2}>
      ...
      <Grid item xs={12}>
        <Grid container className={classes.MuiGridRow} justify="center" spacing={3}>
          ...
          <Grid item>
            <Paper id="future" className={classes.paper}>{props.value}$ is owed for May</Paper>
          </Grid><Grid item>
            <Paper id="future" className={classes.paper}>{props.value}$ is owed for June</Paper>
          </Grid><Grid item>
            <Paper id="future" className={classes.paper}>{props.value}$ is owed for July</Paper>
          </Grid><Grid item>
            <Paper id="future" className={classes.paper}>{props.value}$ is owed for August</Paper>
          </Grid><Grid item>
            <Paper id="future" className={classes.paper}>{props.value}$ is owed for September</Paper>
          </Grid><Grid item>
            <Paper id="future" className={classes.paper}>{props.value}$ is owed for October</Paper>
          </Grid>
        </Grid>
      </Grid>
    </Grid>
