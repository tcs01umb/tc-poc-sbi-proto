...
import {Switch,ExpansionPanel,ExpansionPanelSummary,ExpansionPanelDetails,Grid,Table,TableBody,TableCell,TableHead,TableRow,Button,Typography, Card, CardHeader,Avatar,CardContent} from '@material-ui/core';
    ...
    .then(response => {    
        console.log(response.data)        
            ...
            if(this.state.basePolicies && this.state.basePolicies.length > 0) {
                this.state.basePolicies.forEach((basePolicy)=>{
